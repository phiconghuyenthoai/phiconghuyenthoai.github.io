...
function soSanhChieuDai(){
  var chieuDaiMoTaChuongTrinh = $('#moTaChuongTrinh').height();
    ...
    if (chieuDaiMoTaChuongTrinh > chieuDaiMoTaChuongTrinh) {
                  $('#moTaChuongTrinh').height($('#bangHocPhi').height());

    }else{
      $('#bangHocPhi').height($('#moTaChuongTrinh').height());
